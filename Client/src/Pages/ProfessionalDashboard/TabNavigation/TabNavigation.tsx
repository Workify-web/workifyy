...
type Tab = "Jobs" | "Ongoing Jobs" | "Bids";

const TabNavigation: React.FC = () => {
  const [activeTab, setActiveTab] = useState<Tab>("Jobs");

  const tabs: Tab[] = ["Jobs", "Ongoing Jobs", "Bids"];
      ...
      <div className="">
        ...
        {activeTab === "Ongoing Jobs" && (
          <div className="flex flex-col text-white">
            ...
            {/* Render content for Ongoing Jobs */}
            <OngoingJobs />
            <OngoingJobs />
            <OngoingJobs />
          </div>
        ...
        {activeTab === "Bids" && (
          <div className="flex flex-col">
            ...
            {/* Pass the bid data to BidCard */}
            <BidCard bid={sampleBid} />
            <BidCard bid={sampleBid} />
            <BidCard bid={sampleBid} />
            {/* Render content for Bids */}
