  ...
  return (
    <nav className="sticky top-0 z-50 bg-black p-4 px-10 text-white shadow-md">
      <div className="container mx-auto flex items-center justify-between">
        {" "}
        <Link
          to="/dashboard/Professionaldashboard"
        ...
        <div
          className={`items-center space-x-4 miniLaptop:flex miniLaptop:space-x-8 laptop:flex laptop:space-x-8 desktop:flex desktop:space-x-8 largeDesktop:flex largeDesktop:space-x-8 ${isMenuOpen ? "block" : "hidden"} xsMobile:hidden miniMobile:hidden mobile:hidden miniTablet:hidden tablet:hidden`}
        >
          ...
          <div
            ...
            ref={notificationRef as React.RefObject<HTMLDivElement>}
          >
