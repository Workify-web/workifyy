...
const ProfessionalWallet: React.FC = () => {
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="flex justify-between">
            <button
              ...
              className={`px-6 py-3 xsMobile:px-1 xsMobile:text-sm miniMobile:px-1 miniMobile:text-sm mobile:px-2 mobile:text-sm miniTablet:px-2 miniTablet:text-lg tablet:px-1 ${activeTab === "balance" ? "text-[#32cd32] desktop:rounded desktop:border-b-4 desktop:border-b-[#32cd32] largeDesktop:rounded largeDesktop:border-b-4 largeDesktop:border-b-[#32cd32]" : ""}`}
            >
              Balance
            </button>
            <button
              onClick={() => setActiveTab("history")}
              className={`px-6 py-3 xsMobile:px-1 xsMobile:text-sm miniMobile:px-1 miniMobile:text-sm mobile:px-2 mobile:text-sm miniTablet:px-2 miniTablet:text-lg ${activeTab === "history" ? "text-[#32cd32] desktop:rounded desktop:border-b-4 desktop:border-b-[#32cd32] largeDesktop:rounded largeDesktop:border-b-4 largeDesktop:border-b-[#32cd32]" : ""}`}
            >
              History
            </button>
            <button
              onClick={() => setActiveTab("settings")}
              className={`px-6 py-3 xsMobile:px-1 xsMobile:text-sm miniMobile:px-1 miniMobile:text-sm mobile:px-2 mobile:text-sm miniTablet:px-2 miniTablet:text-lg ${activeTab === "settings" ? "text-[#32cd32] desktop:rounded desktop:border-b-4 desktop:border-b-[#32cd32] largeDesktop:rounded largeDesktop:border-b-4 largeDesktop:border-b-[#32cd32]" : ""}`}
            >
              Settings
            </button>
            <button
              onClick={() => setActiveTab("notifications")}
              className={`px-6 py-3 xsMobile:px-1 xsMobile:text-sm miniMobile:px-1 miniMobile:text-sm mobile:px-2 mobile:text-sm miniTablet:px-2 miniTablet:text-lg ${activeTab === "notifications" ? "text-[#32cd32] desktop:rounded desktop:border-b-4 desktop:border-b-[#32cd32] largeDesktop:rounded largeDesktop:border-b-4 largeDesktop:border-b-[#32cd32]" : ""}`}
            >
              Notifications
            </button>
          </div>
