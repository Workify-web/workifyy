...
import { ActionType } from "./BidCard";
...
interface CounterModalProps extends BaseModalProps {
...
const JobManagement = () => {
  ...
  const handleAction = (
    ...
    bidData: { bidderName: string; bidAmount: number; bidderImage: string },
  ) => {
  ...
  const handleRejectBid = () => {
    // Implement bid rejection logic here
    console.log("Rejecting bid:", selectedBid);
    handleCloseModal();
  };

  const handleCounterBid = (amount: number) => {
